...
- [ ] Создать `backend/llm/validators.py` для валидации JSON ответов LLM
...
- [ ] Создать интерфейсы для JSON структур LLM
- [ ] Добавить типы для валидации ответов

**Тестирование:**
- [ ] Создать unit-тесты для эмулятора
- [ ] Протестировать различные сценарии эмуляции
...
**Backend:**
- [ ] Создать `POST /api/requests/{id}/analyze/` - запуск анализа через эмулятор (возвращает JSON для формы)
- [ ] Добавить валидацию входных данных
- [ ] Создать сериализаторы для LLM запросов и ответов
- [ ] Реализовать обработку ошибок LLM с повторными попытками
- [ ] Добавить логирование всех запросов к LLM
- [ ] Создать `backend/llm/serializers.py` для валидации JSON ответов
- [ ] Добавить endpoint для получения всех артистов для LLM (`GET /api/artists/for-llm/`)

**Тестирование:**
- [ ] Протестировать API через Postman с различными запросами
- [ ] Проверить валидацию JSON ответов эмулятора
- [ ] Протестировать обработку ошибок и повторные попытки

**Frontend:**
- [ ] Создать сервис `requestsService.analyzeRequest(id)`
- [ ] Создать компонент `LLMStatusIndicator` для отображения статуса анализа
- [ ] Добавить типы TypeScript для LLM запросов и ответов

**Тестирование:**
- [ ] Протестировать API через Postman/curl
- [ ] Протестировать фронтенд интеграцию с API
- [ ] Проверить отображение статуса анализа
...
- [ ] Добавить кнопку "Создать из запроса" в `RequestsTable`

**Backend:**
- [ ] Создать `POST /api/projects/` - создание проекта (с поддержкой `request_id`)
- [ ] Создать `GET /api/projects/` - список проектов агента
- [ ] Создать сериализаторы для Project
- [ ] Обновить модель Project для связи с Request

**Тестирование:**
- [ ] Протестировать создание проекта вручную
- [ ] Протестировать создание проекта из запроса
...
- [ ] Создать API для работы с ролями проекта (`POST /api/project-roles/`)
- [ ] Обновить сериализаторы для ProjectRole
- [ ] Добавить поддержку `suggested_artists` и `skills_required` в ProjectRole

**Тестирование:**
- [ ] Протестировать создание проекта с несколькими ролями
