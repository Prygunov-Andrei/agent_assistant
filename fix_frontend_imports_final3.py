#!/usr/bin/env python3
"""
Финальный скрипт для исправления импортов в frontend тестах - исправление путей к компонентам
"""
...
def fix_frontend_imports_in_file(file_path):
    ...
    replacements = [
        ...
        (r"from \"LoadingSpinner\"", "from \"../components/LoadingSpinner\""),
        (r"from 'PersonSelectionComponent'", "from '../components/matching/persons/PersonSelectionComponent'"),
        (r"from \"PersonSelectionComponent\"", "from \"../components/matching/persons/PersonSelectionComponent\""),
        (r"from 'MatchingSuggestions'", "from '../components/people/MatchingSuggestions'"),
        (r"from \"MatchingSuggestions\"", "from \"../components/people/MatchingSuggestions\""),
        ...
        # Исправляем пути к типам
        (r"from '../../../types/", "from '../types/"),
        (r"from \"../../../types/", "from \"../types/"),
        (r"from '../../types/", "from '../types/"),
        (r"from \"../../types/", "from \"../types/"),
        
        # Исправляем пути к сервисам в jest.mock
        (r"jest\.mock\('../../services/", "jest.mock('../services/"),
        (r"jest\.mock\(\"../../services/", "jest.mock(\"../services/"),
    ]
