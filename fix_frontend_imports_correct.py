#!/usr/bin/env python3
"""
Скрипт для правильного исправления импортов в frontend тестах
"""
...
def fix_frontend_imports_in_file(file_path):
    ...
    # Исправляем неправильные пути на правильные
    replacements = [
        # Убираем лишние ../src/../src/../src/
        (r'\.\./\.\./\.\./\.\./\.\./\.\./src/\.\./src/\.\./src/\.\./src/', '../../../src/'),
        (r'\.\./\.\./\.\./\.\./\.\./\.\./src/\.\./src/\.\./src/', '../../../src/'),
        (r'\.\./\.\./\.\./\.\./\.\./\.\./src/\.\./src/', '../../../src/'),
        (r'\.\./\.\./\.\./\.\./\.\./\.\./src/', '../../../src/'),
