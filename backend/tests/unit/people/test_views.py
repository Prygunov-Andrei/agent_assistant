...
@pytest.fixture
def authenticated_api_client(api_client, agent):
...
class TestPersonAPI:
    ...
    def test_person_list_authenticated(self, authenticated_api_client):
    ...
    def test_person_list_only_active(self, authenticated_api_client):
    ...
    def test_person_create_authenticated(self, authenticated_api_client, agent):
    ...
    def test_person_retrieve_authenticated(self, authenticated_api_client):
    ...
    def test_person_update_by_creator(self, authenticated_api_client, agent):
    ...
    def test_person_update_by_non_creator(self, authenticated_api_client, another_agent):
    ...
    def test_person_delete_by_creator(self, authenticated_api_client, agent):
    ...
    def test_person_delete_by_non_creator(self, authenticated_api_client, another_agent):
    ...
    def test_person_my_people_endpoint(self, authenticated_api_client, agent):
    ...
    def test_person_search_by_name(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get(url, {'name': 'Иван'})
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 2  # Иван Петров и Петр Иванов

    def test_person_search_by_type(self, authenticated_api_client):
        ...
        url = reverse('person-search')
        response = authenticated_api_client.get(url, {'person_type': 'director'})
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 1
        assert response.data[0]['person_type'] == 'director'

    def test_person_search_by_nationality(self, authenticated_api_client):
        ...
        url = reverse('person-search')
        response = authenticated_api_client.get(url, {'nationality': 'Россия'})
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 1
        assert response.data[0]['nationality'] == 'Россия'

    def test_person_directors_endpoint(self, authenticated_api_client):
    ...
    def test_person_producers_endpoint(self, authenticated_api_client):
    ...
    def test_person_casting_directors_endpoint(self, authenticated_api_client):
    ...
    def test_person_serializer_fields(self, authenticated_api_client):
    ...
    def test_person_list_serializer_fields(self, authenticated_api_client):
