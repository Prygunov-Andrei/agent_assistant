...
class TestAgentAPI:
    ...
    def test_agent_list_authenticated(self, authenticated_api_client):
    ...
    def test_agent_list_only_active(self, authenticated_api_client):
    ...
    def test_agent_create_authenticated(self, authenticated_api_client):
    ...
    def test_agent_retrieve_authenticated(self, authenticated_api_client):
    ...
    def test_agent_update_authenticated(self, authenticated_api_client):
    ...
    def test_agent_delete_authenticated(self, authenticated_api_client):
    ...
    def test_agent_me_endpoint(self, authenticated_api_client, agent):
        """Тест эндпоинта /me/"""
    ...
    def test_agent_update_profile_endpoint(self, authenticated_api_client, agent):
    ...
    def test_agent_serializer_fields(self, authenticated_api_client):
    ...
    def test_agent_list_serializer_fields(self, authenticated_api_client):
