...
class TestProjectTypeAPI:
    ...
    def test_project_type_list_authenticated(self, authenticated_agent_client):
        ...
        url = reverse('projecttype-list')
        response = authenticated_agent_client.get(url)
    ...
    def test_project_type_retrieve(self, authenticated_agent_client):
    ...
    def test_project_type_cannot_be_updated(self, authenticated_agent_client):
        ...
        response = authenticated_agent_client.put(url, {'name': 'Обновленный тип', 'description': 'Новое описание'})
...
class TestGenreAPI:
    ...
    def test_genre_list_authenticated(self, authenticated_agent_client):
    ...
    def test_genre_retrieve(self, authenticated_agent_client):
...
class TestRoleTypeAPI:
    ...
    def test_role_type_list_authenticated(self, authenticated_agent_client):
    ...
    def test_role_type_retrieve(self, authenticated_agent_client):
...
class TestProjectAPI:
    ...
    def test_project_list_authenticated(self, authenticated_agent_client):
    ...
    def test_project_create(self, authenticated_agent_client, agent):
        ...
        response = authenticated_agent_client.post(url, data)
    ...
    def test_project_retrieve(self, authenticated_agent_client):
    ...
    def test_project_update_own(self, authenticated_agent_client, agent):
        ...
        response = authenticated_agent_client.patch(url, data)
    ...
    def test_project_delete_own(self, authenticated_agent_client, agent):
        ...
        response = authenticated_agent_client.delete(url)
    ...
    def test_project_search_by_title(self, authenticated_agent_client):
        ...
        response = authenticated_agent_client.get(url, {'title': 'УникальныйТестФильм'})
    ...
    def test_project_search_by_status(self, authenticated_agent_client):
        ...
        url = reverse('project-search')
        response = authenticated_agent_client.get(url, {'status': 'in_production'})

        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 1
        assert response.data[0]['title'] == 'В производстве'

    def test_project_search_by_type_and_genre(self, authenticated_agent_client):
    ...
    def test_project_list_serializer_fields(self, authenticated_agent_client):
    ...
    def test_project_creation_validation(self, authenticated_agent_client):
...
class TestProjectRoleAPI:
    ...
    def test_project_role_list_authenticated(self, authenticated_agent_client):
    ...
    def test_project_role_retrieve(self, authenticated_agent_client):
    ...
    def test_project_role_by_project(self, authenticated_agent_client, agent):
        ...
        response = authenticated_agent_client.get(url, {'project_id': project1.id})
    ...
    def test_project_role_search_by_name(self, authenticated_agent_client):
        ...
        response = authenticated_agent_client.get(url, {'name': 'УникальныйТестГлавный'})
    ...
    def test_project_role_search_by_media_presence(self, authenticated_agent_client):
        ...
        url = reverse('projectrole-search')
        response = authenticated_agent_client.get(url, {'media_presence': 'yes'})

        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 1
        assert response.data[0]['name'] == 'Медийная роль'

    def test_project_role_list_serializer_fields(self, authenticated_agent_client):
