...
echo "📡 Шаг 1/3: Остановка бота на удаленном сервере..."

ssh -i $SSH_KEY $REMOTE_SERVER "cd /opt/agent_assistant && docker-compose -f docker-compose.prod.yml stop telegram-bot 2>/dev/null || true"
...
# 2. Проверка локального окружения
echo "🔍 Шаг 2/3: Проверка локального окружения..."
...
# 3. Запуск локального бота
echo "🚀 Шаг 3/3: Запуск локального бота..."
