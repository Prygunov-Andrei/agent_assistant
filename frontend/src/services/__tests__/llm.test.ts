...
import { LLMService, LLMUtils } from '../llm';
import api from '../api';
import type { 
  LLMAnalysisResult, 
  LLMStatus, 
...
describe('LLMService', () => {
  ...
  describe('getAnalysisStatus', () => {
    it('should get analysis status successfully', async () => {
      ...
      expect(mockedApi.get).toHaveBeenCalledWith('/api/requests/123/analysis-status/');
  ...
  describe('getLLMStatus', () => {
    it('should get LLM status successfully', async () => {
      ...
      expect(mockedApi.get).toHaveBeenCalledWith('/api/llm/status/');
  ...
  describe('getLLMConfig', () => {
    it('should get LLM config successfully', async () => {
      ...
      expect(mockedApi.get).toHaveBeenCalledWith('/api/llm/config/');
      expect(result.model).toBe('gpt-4o');
  ...
  describe('updateLLMConfig', () => {
    it('should update LLM config successfully', async () => {
      ...
      expect(mockedApi.put).toHaveBeenCalledWith('/api/llm/config/', configUpdate);
  ...
  describe('updateRequestStatus', () => {
    it('should update request status successfully', async () => {
      ...
      expect(mockedApi.patch).toHaveBeenCalledWith('/api/requests/123/', {
  ...
  describe('getMonitoringData', () => {
    it('should get monitoring data successfully', async () => {
      ...
      expect(mockedApi.get).toHaveBeenCalledWith('/api/llm/monitoring/');
  ...
  describe('exportTrainingDataset', () => {
    it('should export training dataset successfully', async () => {
      ...
      expect(mockedApi.post).toHaveBeenCalledWith('/api/llm/export-dataset/', exportRequest);
  ...
  describe('getTrainingDatasets', () => {
    it('should get training datasets successfully', async () => {
      ...
      expect(mockedApi.get).toHaveBeenCalledWith('/api/llm/datasets/');
  ...
  describe('testPrompt', () => {
    it('should test prompt successfully', async () => {
      ...
      expect(mockedApi.post).toHaveBeenCalledWith('/api/llm/test-prompt/', {
        prompt,
        test_data: testData
      });
  ...
  describe('validateResponse', () => {
    it('should validate response successfully', async () => {
      ...
      expect(mockedApi.post).toHaveBeenCalledWith('/api/llm/validate-response/', response);
