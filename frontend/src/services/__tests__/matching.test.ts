...
describe('MatchingService', () => {
  ...
  describe('searchPersons', () => {
    it('should search persons successfully', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/api/persons/search-matches/', mockRequest);
  ...
  describe('searchCompanies', () => {
    it('should search companies successfully', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/api/companies/search-matches/', mockRequest);
      expect(result).toEqual(mockResults);
    });
  ...
  describe('searchProjects', () => {
    it('should search projects successfully', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/api/projects/search-matches/', mockRequest);
      expect(result).toEqual(mockResults);
    });
  ...
  describe('getSearchConfig', () => {
    it('should get search config successfully', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/api/search/config/');
  ...
  describe('getPersonsByType', () => {
    it('should get persons by type successfully', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/api/persons/by-type/?type=director');
